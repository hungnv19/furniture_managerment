...
<body>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="img/noi-that/banner-2.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="hero__items set-bg" data-setbg="img/noi-that/banner-3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
            ...
            <div class="hero__items set-bg" data-setbg="img/noi-that/banner-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
            ...
            <div class="row product__filter">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="img/noi-that/sp-3.jpg">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="img/noi-that/sp-6.jpg">
                            <span class="label">Sale</span>
                            <ul class="product__hover">
                                <li><a href="#"><img src="img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="img/icon/compare.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="categories__text">
                        <h2>PHÒNG NGỦ<br /> <span>PHÒNG KHÁCH</span> <br /> PHÒNG ĂN</h2>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="categories__hot__deal">
                        <img src="img/noi-that/sp-sale.jpg" alt="">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        <div class="instagram__pic__item set-bg" data-setbg="img/noi-that/ins-1.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="img/noi-that/ins-2.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="img/noi-that/ins-3.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="img/noi-that/ins-4.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="img/noi-that/ins-5.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="img/noi-that/ins-6.jpg"></div>
                    </div>
                </div>
                <div class="col-lg-4">
    ...
    <section class="latest spad">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="img/noi-that/tin-2.jpg"></div>
                        <div class="blog__item__text">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="img/noi-that/tin-3.jpg"></div>
                        <div class="blog__item__text">
